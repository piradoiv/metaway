...
Begin MobileScreen MainScreen
   ...
   Begin ActionButtonContainer NewPictureActionButton
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   NewPictureActionButton, 4, <Parent>, 10, False, +1.00, 4, 1, -10, , True
      ...
      AutoLayout      =   NewPictureActionButton, 3, TopLayoutGuide, 4, False, +1.00, 4, 1, *kStdControlGapV, , True
      Caption         =   "Take a metadata free picture"
      ControlCount    =   0
      Enabled         =   True
      Height          =   201
      IconName        =   "camera"
   ...
   Begin ActionButtonContainer RemoveMetadataActionButton
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   RemoveMetadataActionButton, 8, NewPictureActionButton, 8, False, +1.00, 4, 1, 0, , True
      ...
      Caption         =   "Remove metadata from a picture of your library"
      ControlCount    =   0
      Enabled         =   True
      Height          =   201
      IconName        =   "photo"
